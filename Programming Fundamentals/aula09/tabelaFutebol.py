...
tab = sorted(tabela, key= lambda equipa: equipa[GM] - equipa[GS], reverse=True)
printTabela(tab)
...
tab = sorted(tabela, key = lambda equipa: (pontos(equipa), equipa[GM] - equipa[GS]), reverse=True)
printTabela(tab)
