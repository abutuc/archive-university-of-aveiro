Feature: Book search
  ...
  Scenario: Search books by publication year
    Given a book with the title 'One good book', written by 'Anonymous', published in 2013-08-14
  ...
  Scenario: Search books by publication year with table
    Given the following books
      | title              | author          | published  |
      | One good book      | Anonymous       | 2013-08-14 |
