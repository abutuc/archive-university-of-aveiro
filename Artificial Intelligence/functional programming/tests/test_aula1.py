...
def test_lista_subconjuntos(mock_lista_subconjuntos):
    list_result = mock_lista_subconjuntos([1,2,3])
    list_result.sort()
    list_expected = [[],[1],[2],[3],[1,2],[1,3],[2,3],[1,2,3]]
    list_expected.sort()
    assert list_result == list_expected
