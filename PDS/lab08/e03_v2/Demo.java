...
public class Demo {
    ...
    private static Star createStar(char type) {
        ...
        Star star=null;
        switch (type) {
        case 'O' : star = new Star(cache[0], x, y); break;
        case 'A' : star = new Star(cache[1], x, y); break;
        case 'B' : star = new Star(cache[2], x, y); break;
        case 'F' : star = new Star(cache[3], x, y); break;
        case 'G' : star = new Star(cache[4], x, y); break;
        case 'K' : star = new Star(cache[5], x, y); break;
        case 'M' : star = new Star(cache[6], x, y); break;
        }
        return star;
    }
